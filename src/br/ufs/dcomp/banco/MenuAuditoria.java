...
public class MenuAuditoria {
    ...
    public void menuPrincipal() {
        ...
        System.out.println(//" 1 - Para cadastrar um banco " 
                ...
                + "5 - Para cadastrar um cliente. "
                + " 6 - Para criar uma conta."
        ...
        switch (opcao) {
            ...
            case 3:
                ...
                for (int i = 0; i < bancos.size(); i++) {
                    if (numeroBanco == bancos.get(i).getCodigo()) {
                        System.out.println(" Montante do banco:" + bancos.get(i).getMontante());
                    }
            ...
            case 4:
                ...
                rg = ler.next();
                for (int i = 0; i < bancos.size(); i++) { // consertar a partir daqui
                    if (numeroBanco == bancos.get(i).getCodigo()) {
                        System.out.println(" Saldo do cliente no banco:"
                                + bancos.get(i).getSaldoCliente(rg));// até aqui
                    }
                }
